"""
Django settings for authPractices project.
...
SECRET_KEY = 'django-insecure-*x2f47)jyti+sa@rd=$t)&6)ri4y^7ro@tj!*z^w*_+_(6p@z8'
...
ROOT_URLCONF = 'authPractices.urls'
...
WSGI_APPLICATION = 'authPractices.wsgi.application'
